      ...
      <div className="w-full min-h-fit sm:max-w-5xl sm:mx-auto bg-[#F4F4F4] sm:bg-white rounded-lg drop-shadow-lg">
        <div className="px-5 md:px-10 pt-10 md:flex justify-between items-center">
          <div className="mb-5 md:max-w-lg">
            ...
            <Link href="/" passHref>
              <a className="bg-primary rounded-full w-full text-center text-white flex justify-center md:max-w-xs gap-3 p-3 text-sm items-center">
        ...
        <div className="w-full rounded-b-lg h-20 bg-gradient-to-bl from-[#09263D] to-[#1C71B7] mt-5 text-white text-center px-10 py-2">
          <div className="flex justify-between items-start h-full md:max-w-2xl md:mx-auto">
            <div className="border-r h-full flex flex-col items-center justify-center px-5 md:px-16">
            ...
            <div className="h-full flex flex-col items-center justify-center px-5 md:px-16">
