  ...
  return (
    <section className="relative w-full p-5 mb-10 min-h-fit">
      <div className="w-full min-h-fit 
       max-w-7xl
      sm:mx-auto bg-[#F4F4F4] sm:bg-white rounded-lg drop-shadow-lg">
        <div className="items-center justify-between px-5 pt-10 md:px-10 md:flex">
          <div className="mb-5 md:max-w-sm lg:max-w-lg">
            ...
            <p className="mb-5 text-sm sm:text-base lg:text-[1.4rem] 
            font-light
            md:leading-[2rem]">
            ...
            <Link href="/" passHref>
              ...
              h-[70px]
              w-full gap-3 py-3 text-xs font-bold text-center text-white rounded-full 
              md:text-[18px] bg-primary md:max-w-[350px] sm:p-3 sm:text-sm">
