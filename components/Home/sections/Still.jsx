...
const Still = () => {
  return (
    <section className="relative w-full p-5 mb-14 min-h-fit md:px-10">
      <div className="mb-10">
        <h1 className="mb-2 max-w-[20rem] mx-auto text-3xl font-bold text-center md:text-[3.3rem] sm:text-4xl sm:mb-3 md:mb-5">
          Still not yet <span className="text-[#8B0093]">convinced</span>?
        </h1>
        <p className="text-sm max-w-[15rem] mx-auto text-center md:text-xl sm:text-base">
