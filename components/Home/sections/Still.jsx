...
const Still = () => {
  return (
    <section className="relative  w-full p-5 mb-14 min-h-fit md:px-10">
      <div className="mb-10">
        <h1 className="mb-2  lg:max-w-fit md:leading-[4rem] mx-auto text-3xl font-bold text-center md:text-[3.3rem] sm:text-4xl sm:mb-3 md:mb-5">
      ...
      <div className="grid
      max-w-7xl
      place-items-center grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-10 w-full text-center md:grid-cols-  mx-auto">
        {data.map((d, i) => (
